...
// rounded-rect card the host renders. #4D6BFE is DeepSeek's published brand
// blue; the mark is reversed out in white so it reads on the card.
  ...
  credentialFields: [
    {
      ...
      placeholder: "sk-...",
      helpLink: {
        label: "Create a DeepSeek API key",
...
export const plugin: Plugin = {
  manifest,
  resourceTypes,
  createClient: (credentials, services) => new DeepSeekClient(credentials, services),
};
