...
export const ClusterResourceType: ResourceTypeDefinition = {
  ...
  fields: [
    ...
    { key: "clusterName", label: "Cluster Name", kind: "string", required: true },
    {
      ...
      kind: "enum",
      required: true,
      enumValues: ["PENDING", "RUNNING", "RESTARTING", "RESIZING", "TERMINATING", "TERMINATED", "ERROR", "UNKNOWN"],
    },
    ...
    { key: "autoterminationMinutes", label: "Auto-termination (min)", kind: "number", required: false },
