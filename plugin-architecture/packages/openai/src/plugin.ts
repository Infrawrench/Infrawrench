...
import { FineTuningJobResourceType } from "./resources/fine-tuning-job.js";
...
const manifest: PluginManifest = {
  ...
  logoSvg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
    ...
    <g transform="translate(20,20) scale(2.5)" fill="#ffffff">
  ...
  credentialFields: [
    {
      ...
      placeholder: "sk-proj-…",
      helpLink: {
        label: "Create a project API key",
...
const resourceTypes: ResourceTypeDefinition[] = [
  ModelResourceType,
  FineTuningJobResourceType,
  BatchResourceType,
  FileResourceType,
  VectorStoreResourceType,
