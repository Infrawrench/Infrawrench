...
export const ACMCertificateResourceType: ResourceTypeDefinition = {
  ...
  fields: [
    { key: "domainName", label: "Domain Name", kind: "string", required: true },
    {
      ...
      kind: "enum",
      required: true,
      enumValues: ["PENDING_VALIDATION", "ISSUED", "INACTIVE", "REVOKED", "EXPIRED", "VALIDATION_TIMED_OUT", "FAILED"],
    },
    { key: "type", label: "Type", kind: "enum", required: false, enumValues: ["IMPORTED", "AMAZON_ISSUED", "PRIVATE"] },
