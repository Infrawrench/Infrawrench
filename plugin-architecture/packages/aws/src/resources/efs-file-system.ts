...
export const EFSFileSystemResourceType: ResourceTypeDefinition = {
  ...
  fields: [
    ...
    { key: "lifeCycleState", label: "State", kind: "enum", required: true, enumValues: ["creating", "available", "updating", "deleting", "deleted", "error"] },
    { key: "performanceMode", label: "Performance Mode", kind: "enum", required: false, enumValues: ["generalPurpose", "maxIO"] },
    { key: "throughputMode", label: "Throughput Mode", kind: "enum", required: false, enumValues: ["bursting", "provisioned", "elastic"] },
