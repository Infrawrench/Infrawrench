...
export const MSKClusterResourceType: ResourceTypeDefinition = {
  ...
  fields: [
    { key: "clusterName", label: "Cluster Name", kind: "string", required: true },
    {
      ...
      kind: "enum",
      required: true,
      enumValues: ["ACTIVE", "CREATING", "DELETING", "FAILED", "HEALING", "MAINTENANCE", "REBOOTING_BROKER", "UPDATING"],
    },
  ...
  secretExportTemplates: [
    {
      ...
      entries: [
        { envKey: "KAFKA_BROKERS", outputKey: "bootstrapBrokers", description: "Comma-separated broker endpoints" },
      ],
    },
  ],
};
