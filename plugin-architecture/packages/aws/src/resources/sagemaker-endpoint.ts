...
export const SageMakerEndpointResourceType: ResourceTypeDefinition = {
  ...
  fields: [
    { key: "endpointName", label: "Endpoint Name", kind: "string", required: true },
    {
      ...
      kind: "enum",
      required: true,
      enumValues: ["OutOfService", "Creating", "Updating", "SystemUpdating", "RollingBack", "InService", "Deleting", "Failed", "UpdateRollbackFailed"],
    },
  ...
  outputs: [
    { key: "endpointArn", label: "Endpoint ARN", sensitive: false },
  ],
