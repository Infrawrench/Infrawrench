...
![Cohere Speech tab on a model, showing the transcribe half with the required language picker](https://agent-assets.infrawrench.com/docs/screenshots/plugins/cohere-speech.png)
