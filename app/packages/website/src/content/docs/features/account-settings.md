...
![Settings → General showing the Profile, Password, Two-factor authentication, and Active sessions cards](https://agent-assets.infrawrench.com/docs/screenshots/settings/general.png)
...
![Add authenticator app dialog showing the QR code, manual setup key, and six-digit code field](https://agent-assets.infrawrench.com/docs/screenshots/settings/mfa-enroll.png)
...
![Settings → General Delete account card showing the sole-member warning that Acme will be deleted too, above the Delete account button](https://agent-assets.infrawrench.com/docs/screenshots/settings/delete-account.png)
