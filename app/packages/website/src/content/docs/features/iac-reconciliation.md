...
![The Adopt into Terraform modal showing generated import blocks above the resource stanzas, with the Copy HCL and Download buttons](https://agent-assets.infrawrench.com/docs-screenshots/features/iac-reconciliation/adopt-into-terraform-modal.png)
