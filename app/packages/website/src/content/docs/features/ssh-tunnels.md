...
![SSH tunnel config form with bastion, target host, target port, and local port fields](https://agent-assets.infrawrench.com/docs/screenshots/features/ssh-tunnel-config.png)
