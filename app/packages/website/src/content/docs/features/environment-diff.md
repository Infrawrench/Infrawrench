...
![The Env diff screen with a staging and a production account selected, showing the inventory table with a count delta and one resource type flagged as missing, and a field divergence below it](https://agent-assets.infrawrench.com/docs/screenshots/features/environment-diff.png)
