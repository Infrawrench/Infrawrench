...
<insert [Mobile Dashboards tab showing the default dashboard: a pinned resource card, a stacked-bar cost graph with its legend totals, and a budget card with its progress bar] here>
