...
![KV console with a few SET / GET commands and their replies](https://agent-assets.infrawrench.com/docs-screenshots/features/kv-console/redis-console-commands.png)
