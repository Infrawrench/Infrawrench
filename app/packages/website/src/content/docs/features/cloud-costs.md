...
Every threshold fires at most once per calendar month. Alerts show up as a badge on the budget card, and — if your org has [Twilio paging](../features/workflows.md) configured — as an SMS to your on-call recipients.
