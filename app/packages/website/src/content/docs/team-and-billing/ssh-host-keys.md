...
![Trusted SSH Hosts settings page with the table of pinned hosts, fingerprints, and Revoke buttons](https://agent-assets.infrawrench.com/docs/screenshots/settings/ssh-host-keys.png)
