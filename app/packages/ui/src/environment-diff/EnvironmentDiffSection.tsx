  ...
  return (
    <div className="flex-1 overflow-auto p-6">
      ...
      <AccountPairPickers
        ...
        a={a}
        b={b}
        includeIdentityFields={includeIdentityFields}
        onSelect={select}
        onIncludeIdentityFieldsChange={setIncludeIdentityFields}
      />
      ...
      {data !== null && (
        <EnvironmentDiffResults data={data} nameOf={nameOf} onOpenResource={onOpenResource} />
      )}
    </div>
  );
}

function AccountPairPickers({
  accounts,
  optionsB,
  a,
  b,
  ...
  onSelect,
  onIncludeIdentityFieldsChange,
}: {
  accounts: EnvironmentDiffAccount[] | null;
  optionsB: EnvironmentDiffAccount[];
  a: string;
  b: string;
      ...
      <label className="flex flex-col gap-1 text-xs">
        ...
        <select
          ...
          onChange={(e) => {
            ...
            onSelect({ a: nextA, b: stillComparable ? b : "" });
          }}
...
function EnvironmentDiffResults({
  data,
  nameOf,
  onOpenResource,
}: {
