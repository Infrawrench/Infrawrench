...
const OrgOrgIdSettingsAuditLogRoute = OrgOrgIdSettingsAuditLogRouteImport.update({
  id: "/audit-log",
  path: "/audit-log",
  getParentRoute: () => OrgOrgIdSettingsRoute,
} as any);
...
const OrgOrgIdDashboardDashboardIdRoute = OrgOrgIdDashboardDashboardIdRouteImport.update({
  id: "/dashboard/$dashboardId",
  path: "/dashboard/$dashboardId",
  getParentRoute: () => OrgOrgIdRoute,
} as any);
const OrgOrgIdAccountsAccountIdRoute = OrgOrgIdAccountsAccountIdRouteImport.update({
...
const OrgOrgIdSettingsRouteWithChildren = OrgOrgIdSettingsRoute._addFileChildren(
  OrgOrgIdSettingsRouteChildren,
);
...
const OrgOrgIdRouteWithChildren = OrgOrgIdRoute._addFileChildren(OrgOrgIdRouteChildren);
