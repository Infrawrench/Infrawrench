...
// WorkOS Authentication API origin. Use your custom auth API domain here if
// one is configured in WorkOS (Dashboard > Domains) — production uses
// https://auth-api.infrawrench.com.
