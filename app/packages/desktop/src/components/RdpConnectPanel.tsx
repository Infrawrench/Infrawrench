...
interface RdpConnectPanelProps {
  host: string;
  defaultUsername?: string | null;
  onConnect: (connection: RdpConnection) => void;
}

// RDP has no key-based auth like SSH, and we deliberately never store the
// password — so this form shows every time a session is opened.
export function RdpConnectPanel({ host, defaultUsername, onConnect }: RdpConnectPanelProps) {
